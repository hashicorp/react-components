...
export const ThreeUpWithHeading = () => {
  return (
    <Callouts
...
export const WithCustomContent = () => (
  <Callouts
    heading="Engagement Model"
    subheading="Meet your business goals with our end-to-end services. Our expert engineers  leverage reference architectures and proven best practices to deliver complete design, build, validation and go-live project phases."
    centerHeading={true}
    layout="two-up"
    items={[
      {
...
export default {
  title: 'Blocks|Callouts/Examples',
  component: Callouts,
