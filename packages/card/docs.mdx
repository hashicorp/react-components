...
>
  <Card link="https://hashicorp.com">
    <Card.Content>
      ...
      />
      <Card.Heading>
        Display 5 - 4 lines with character limit of 130. Leo mauris fermentum
        pharetra blandit tellus euismod…
      </Card.Heading>
    </Card.Content>
  </Card>
  <Card link="https://hashicorp.com">
    <Card.Content>
      ...
      <Card.Description>
        Body small - 4 lines with character limit of 170. Leo mauris fermentum
        pharetra blandit tellus euismod pharetra. Duis egestas volutpat dolor…
      </Card.Description>
    </Card.Content>
  </Card>
  <Card link="https://hashicorp.com">
