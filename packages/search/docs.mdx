...
Optional `settings` object that can be used to configure the given index's settings. [:point_right: Browse available settings](https://www.algolia.com/doc/api-reference/settings-api-parameters/)
