...
function SvgBoundaryLogoColor(props) {
  return (
    <div className="g-svg">
      <img
        src="data:image/png;base64,"
        className="svg-sizer"
        alt=""
        role="presentation"
      />
      <svg viewBox="0 0 310 67" height={67} width={310} {...props}>
        <defs>
