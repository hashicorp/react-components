...
import Subnav from './dist/index.js'
...
describe('<Subnav />', () => {
  it('should render a `.g-subnav` <nav> root element', () => {
  ...
  it('should render all top-level menuItems as expected', () => {
  ...
  it('should highlight the dropdown that contains the active link', () => {
  ...
  it('should use a provided Link component to render all links', () => {
  ...
  it('should render ctaLinks as hyperlinks', () => {
  ...
  it('should render the title linked to the titleUrl', () => {
    const { titleLink } = baseProps
  ...
  it('should render product logos for product titles, with alt text', () => {
    const logoSlugs = [
      'terraform',
      'vault',
      'consul',
